...
export const uiText = {
  ...
  instanceFilterAll: "全部实例",
  instanceFilterConsumer: "用户实例",
  instanceFilterConsole: "控制台实例",
  noInstancesForFilter: "当前筛选条件下没有实例。",
  ...
  hostId: "宿主机ID",
  currentStatus: "当前状态",
  instanceOwnership: "实例归属",
  instanceOwnershipConsumer: "已绑定用户",
  instanceOwnershipConsole: "控制台实例",
  consumerBindingCount: "绑定用户数",
  boundUsers: "关联用户",
  createdAt: "创建时间",
  start: "启动",
  stop: "停止",
  ...
  deleteBoundInstanceWarningTitle: "该实例已绑定 C 端用户",
  deleteBoundInstanceWarningDescription: "为了避免误删真实在用实例，请先确认实例名，并仅在你明确知道影响范围时再继续删除。",
  deleteBoundInstanceInputLabel: "请输入实例名确认删除",
  deleteBoundInstanceInputPlaceholder: "输入实例名后才可删除",
  ...
  templateApplyFailedPrefix: "模板下发失败：",
  ...
  skillScopeHint: "Skill 属于实例工作区共享能力，当前 Agent 能否调用由 allowed_skills 限制",
  agentAllowedTools: "allowed_tools",
  agentAllowedSkills: "allowed_skills",
  ...
  agentSkillNotAllowed: "当前 Agent 的 allowed_skills 未包含该 Skill ID，可能无法直接读取或注入该 Skill",
  ...
  instanceReadonlyNoticeTitle: "当前处于模板托管只读模式",
  ...
  instanceRestartRequiredTag: "有未重启改动",
  instanceRestartRequiredAlertTitle: "当前实例有未重启改动",
  instanceRestartRequiredAlertDescription: "最近保存的配置尚未通过重启实例生效。重启成功后，这个标记会自动消失。",
