...
export function AccountSidebar({
  ...
  return (
    <aside className="flex rounded-[28px] bg-white/72 px-5 py-6 shadow-[0_20px_48px_rgba(15,23,42,0.05)] backdrop-blur-xl xl:h-full xl:min-h-0 xl:overflow-hidden">
      <div className="flex min-h-[calc(100vh-48px)] w-full flex-col xl:h-full xl:min-h-0">
        <Link
          href="/"
        ...
        <div className="mt-12 flex-1 overflow-y-auto pr-1" style={{ scrollbarGutter: "stable" }}>
