  ...
  return (
    ...
    >
      <motion.div
        ...
        className="fixed bottom-4 top-4 z-20 hidden overflow-y-auto rounded-r-[28px] border border-l-0 border-md-outline-variant/25 bg-white/76 px-4 py-5 shadow-[0_20px_48px_rgba(15,23,42,0.06)] backdrop-blur-2xl xl:flex xl:flex-col"
      >
